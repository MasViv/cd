...
{
  GameStatus="true";
  document.getElementById("status").innerHTML="Loading...Loading...6 and 1/2 hours later...Loading...Loading";
}
function game(){
  ...
  if(gameConfig.status==='start'){
    ...
    textSize(40);
    textAlign(CENTER);
    text("Press Start! Read em all! Like pokemon, catch em all, ya know?", gameConfig.screenX/2, gameConfig.screenY/2);
    textSize(40);
